...
public class AccountRepository {
...

    {
        ...
        account.withdraw(anAmountOf(1000.0D), LocalDateTime.of(2019, Month.JUNE, 01, 7, 30), "Test withdrawal");
        account.deposit(anAmountOf(100.0D), LocalDateTime.of(2019, Month.JUNE, 01, 8, 30), "Test deposit");
        account.deposit(anAmountOf(200.0D), LocalDateTime.of(2019, Month.JUNE, 01, 9, 30), "Test deposit");
        account.withdraw(anAmountOf(300.0D), LocalDateTime.of(2019, Month.JUNE, 01, 10, 30), "Test withdrawal");
        accounts.put(account.getAccountNumber(), account);

        Account otherAccount = anEmptyAccount(30005678L);
        otherAccount.setDescription("My steady savings account");
        otherAccount.deposit(anAmountOf(120.0D), LocalDateTime.of(2019, Month.JUNE, 01, 07, 30), "Test deposit");
