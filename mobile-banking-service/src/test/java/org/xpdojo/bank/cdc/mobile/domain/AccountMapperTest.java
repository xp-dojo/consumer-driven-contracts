...
public class AccountMapperTest {
    ...
    private static final String JSON = "{\"accountNumber\":30005432,\"description\":\"A description\",\"overdraftFacility\":{\"value\":1000.0},\"balance\":{\"value\":90.0}}";
    private static final Account ACCOUNT = new Account(30005432L, "A description", new Money(1000.0D), new Money(90.0D));
